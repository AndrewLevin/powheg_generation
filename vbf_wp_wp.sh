...
python ./run_pwg.py -p 0 -i powheg.input -m vbf_wp_wp -f my_working_directory
...
#python ./run_pwg.py -p 3 -i powheg.input -m vbf_wp_wp -f my_working_directory -q 1nw -t 50000 -n 1000
#wget https://raw.githubusercontent.com/AndrewLevin/genproductions/wpwp_powheg/bin/Powheg/production/wp_wp_j_j_ewk/powheg.input.step4
#mv powheg.input.step4 powheg.input
#python ./run_pwg.py -p 4 -i powheg.input -m vbf_wp_wp -f my_working_directory -q 1nw -t 50000 -n 1000
